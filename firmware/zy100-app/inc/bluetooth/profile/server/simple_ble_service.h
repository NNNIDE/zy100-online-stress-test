...
typedef enum
{
    ...
    SIMPLE_BLE_SERVICE_PARAM_V5_CFG_CHAR_VAL = 0x02,
} T_SIMP_PARAM_TYPE;
...
#define SIMP_READ_V5_MAX_LEN               32
/* Keep write bound conservative until external BLE protocol frame length is finalized. */
#define SIMP_WRITE_V2_MAX_LEN              SIMP_READ_V1_MAX_LEN
#define SIMP_WRITE_V5_REQ_LEN              16
#define SIMP_WRITE_V5_MAX_LEN              SIMP_READ_V5_MAX_LEN
...
/**
  ...
  * @retval 0 false
  */
bool simp_ble_service_send_v5_notify(uint8_t conn_id, T_SERVER_ID service_id,
                                     void *p_value, uint16_t length);
