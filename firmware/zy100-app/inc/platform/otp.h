...
typedef struct otp_struct
{
    ...
    uint8_t rsvd02[77];
    uint16_t rsvd03[56];                     //0x0020023a
    uint8_t rsvd04;
    uint8_t rsvd05: 7;
    uint8_t not_FR1: 1;
    uint8_t xtal_cap_calibration_40M;       /* 0x00~0x7F */
    uint8_t rsvd06[1];
    uint8_t rsvd07[14];                     //0x002002ae
    ...
    uint32_t reserved32;                 //0x002003d0
    ...
    uint8_t  flash_spec_cfg_rsvd0;
    uint16_t flash_front_delay;
    uint8_t  flash_spec_cfg_rsvd1[9];
    uint16_t flash_rear_delay;
    uint8_t  flash_spec_cfg_rsvd2[58];  // start addr: 0x0020045C, size:0x3A
