...
*/
bool flash_read_unique_id_winbond_locked(uint8_t *unique_id);

/* Keep the alias of flash_read_unique_id_winbond_locked() for backward compatibility. */
...
*/
bool flash_read_unique_id_gd_locked(uint8_t *unique_id);

/* Keep the alias of flash_read_unique_id_gd_locked() for backward compatibility. */
bool flash_read_unique_id_gd(uint8_t *unique_id);

/**
 * @brief  read 8 bytes UUID for XMC flash
 * @param  unique_id    UUID
 * @return true if getting UUID successfully
*/
bool flash_read_unique_id_xmc_locked(uint8_t *unique_id);
 ...
 * @ret   true if success
 * @deprecated  This function depends on a customized Patch, please use otp_read() as an alternative
 *              for normal use.
*/
 ...
 * @param length data length to be read, 8 bytes max
 * @ret   true if success
 * @deprecated  This function depends on a customized Patch, please use otp_write() as an alternative
 *              for normal use.
*/
