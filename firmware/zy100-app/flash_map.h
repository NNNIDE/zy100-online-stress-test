...
example:
	...
	4) OTA Bank0:                                    572K (0x00802000)
		a) OTA Header                    4K (0x00802000)
		b) Secure boot loader            4K (0x0080D000)
		c) Patch code                   40K (0x00803000)
		d) Upperstack  Code            120K (0x0080E000)
		e) APP code                    404K (0x0082C000)
		f) APP data1                     0K (0x00891000)
		g) APP data2                     0K (0x00891000)
		h) APP data3                     0K (0x00891000)
		i) APP data4                     0K (0x00891000)
		j) APP data5                     0K (0x00891000)
		k) APP data6                     0K (0x00891000)
	5) OTA Bank1:                                      0K (0x00891000)
	...
	6) FTL:                                           16K (0x00891000)
	7) OTA Tmp:                                      404K (0x00895000)
	8) user data1:                           24K (0x008FA000)
	9) user data2:                            0K (0x00900000)
*/
...
#define FLASH_SIZE                      0x00100000  //1024K Bytes
...
#define OTA_BANK0_SIZE                  0x0008F000  //572K Bytes
#define OTA_BANK1_ADDR                  0x00891000
#define OTA_BANK1_SIZE                  0x00000000  //0K Bytes
#define FTL_ADDR                        0x00891000
#define FTL_SIZE                        0x00004000  //16K Bytes
#define OTA_TMP_ADDR                    0x00895000
#define OTA_TMP_SIZE                    0x00065000  //404K Bytes
#define USER_DATA1_ADDR                 0x008FA000
#define USER_DATA1_SIZE                 0x00006000  //24K Bytes
#define USER_DATA2_ADDR                 0x00900000
...
#define BANK0_APP_SIZE                  0x00065000  //404K Bytes
#define BANK0_APP_DATA1_ADDR            0x00891000
#define BANK0_APP_DATA1_SIZE            0x00000000  //0K Bytes
#define BANK0_APP_DATA2_ADDR            0x00891000
#define BANK0_APP_DATA2_SIZE            0x00000000  //0K Bytes
#define BANK0_APP_DATA3_ADDR            0x00891000
#define BANK0_APP_DATA3_SIZE            0x00000000  //0K Bytes
#define BANK0_APP_DATA4_ADDR            0x00891000
#define BANK0_APP_DATA4_SIZE            0x00000000  //0K Bytes
#define BANK0_APP_DATA5_ADDR            0x00891000
#define BANK0_APP_DATA5_SIZE            0x00000000  //0K Bytes
#define BANK0_APP_DATA6_ADDR            0x00891000
