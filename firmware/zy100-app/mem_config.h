...
#include "flash_map.h"
#include "src/sample/ble_peripheral/app_mode_config.h"
...
#ifndef APP_GLOBAL_SIZE
#if (ZY100_APP_MODE == ZY100_APP_MODE_NORMAL_BLE_SENSOR)
#define APP_GLOBAL_SIZE                (64 * 1024)
#else
/* SDK v1.1.0 moves additional flash-library code into RAM_DATA_ON. */
#define APP_GLOBAL_SIZE                (83 * 1024)
#endif
#endif
