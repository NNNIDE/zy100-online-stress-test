...
#define DFU_NOTIFY_LENGTH_CONN_PARA_UPDATE_REQ  (DFU_NOTIFY_LENGTH_ARV+2+2+2) //connInterval, latency, supervisionTimeout
...
typedef enum
{
    ...
    DFU_OPCODE_IMAGE_VERSION                = 0x0d,
    DFU_OPCODE_MAX                          = 0x0e, /*control point opcode max*/
