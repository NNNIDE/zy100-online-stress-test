...
/**
   ...
   * reset_level: 0, Reset whole chip except partial AON and RTC. 1, Reset whole chip;
   * timeout_second: timeout period in seconds, max value is 262s
   * Note: Power down mode, aon wdg clock source may varify from 450Hz to 2.3KHz
   */
