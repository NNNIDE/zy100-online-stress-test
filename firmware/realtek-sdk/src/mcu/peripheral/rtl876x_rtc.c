...
#define BTAON_FAST_27                   0x27
#define BTAON_FAST_RG1X_32KXTAL_L       0x102
#define BTAON_FAST_RG1X_32KXTAL_H       0x103
#define BTAON_FAST_RG2X_32KXTAL_L       0x104
...
void RTC_SelectSrcToGpioInput(RTC_32K_GPIO_IN gpio)
{
    ...
    btaon_fast_update_safe(BTAON_FAST_27, BIT2 | BIT3, (0x3 << 2));

    /* rtc_in_sel =
       2'b01: gpio_rtc_in = PAD_32K_XI;
       2'b10: gpio_rtc_in = PAD_P2_4
    */
    if (gpio == RTC_32K_XI)
    {
        btaon_fast_update_safe(BTAON_FAST_27, BIT0 | BIT1, 0x1);

        // XTAL32K_SC_XO[5:0] = 0x3F;
        btaon_fast_update_safe(BTAON_FAST_RG1X_32KXTAL_H, 0x3F, 0x3F);

        // XTAL32K_SC_XI[5:0] = 0x3F;
        btaon_fast_update_safe(BTAON_FAST_RG1X_32KXTAL_L, 0xFC, (0x3F << 2));

        // XTAL32K_GPIO_SEL, XTAL32K_SC_XO_EXTRA = 1; XTAL32K_SC_XI_EXTRA = 1;
        btaon_fast_update_safe(BTAON_FAST_RG2X_32KXTAL_L, 0x70, 0x7 << 4);
    }
    else
    {
        btaon_fast_update_safe(BTAON_FAST_27, BIT0 | BIT1, 0x2);
    }
}
