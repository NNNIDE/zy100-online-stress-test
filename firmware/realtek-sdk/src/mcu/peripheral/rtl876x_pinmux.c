...
const uint16_t WKSTATUS_TABLE[TOTAL_PIN_NUM] =
{
    ...
    ((3 << 12) | 0x9a), ((4 << 12) | 0x9a), ((5 << 12) | 0x9a), ((6 << 12) | 0x9a), ((7 << 12) | 0x9a), ((0 << 12) | 0x9b), ((1 << 12) | 0x9b), ((0 << 00) | 0x00),
...
/**
  ...
  * @param  Pin_Num: pin number. Please refer to rtl876x.h "Pin_Number" part.
...
uint8_t Pad_DebounceWakeupStatus(void)
{
    ...
    value8 = btaon_fast_read_safe(0x2b);
    if (value8 & BIT7)
    {
        status_value = SET;
    }
    //Write 1 to clear debounceWakeupStatus
    btaon_fast_write_safe(0x2b, (value8 | BIT7));
    return status_value;
}
