...
volatile uint32_t CODEC_StoreReg[14];
...
volatile uint32_t CODEC_CH0_EQ1_StoreReg[5];
...
volatile uint32_t CODEC_CH0_EQ2_StoreReg[5];
...
volatile uint32_t CODEC_CH0_EQ3_StoreReg[5];
...
volatile uint32_t CODEC_CH0_EQ4_StoreReg[5];
...
volatile uint32_t CODEC_CH0_EQ5_StoreReg[5];
...
volatile uint32_t IF8080_StoreReg[5];
...
void TIM_DLPS_Enter(void)
{
    ...
    TIM_StoreReg[26] = *((volatile uint32_t *)0x40000364UL);
    TIM_StoreReg[27] = *((volatile uint32_t *)0x40000368UL);
...
void TIM_DLPS_Exit(void)
{
    ...
    *((volatile uint32_t *)0x40000364UL) = TIM_StoreReg[26];
    *((volatile uint32_t *)0x40000368UL) = TIM_StoreReg[27];
...
volatile uint32_t
LOG_UART2_StoreReg[12];        /*  This array should be placed in RAM ON/Buffer ON.    */
...
volatile uint32_t
CPU_StoreReg[4];         /*  This array should be placed in RAM ON/Buffer ON.    */
...
/*******************************************************************************************************/
/*******************************************************************************************************/
bool allow_execute_timer_cb = true;   // used for rt-thread os
...
{
    if (lps_mode_get() == LPM_POWERDOWN_MODE)
    {
        btaon_fast_write_safe(BTAON_FAST_RESET_REASON, RESET_REASON_DSS_WAKEUP);
    }
